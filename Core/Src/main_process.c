...
//		}
        ...
        {
            pwm_handler(&htim3, &axis1, cnt1, CH1_CH2,1);
            pwm_handler(&htim3, &axis2, cnt2, CH3_CH4,2);
            pwm_handler(&htim4, &axis3, cnt3, CH1_CH2,3);
            pwm_handler(&htim4, &axis4, cnt4, CH3_CH4,4);
        }
        else
        {
            axis1.pwm = 0;
